package ec.gob.loja.gateway.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("ec.gob.loja.gateway.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("ec.gob.loja.gateway.security.DomainUserDetailsService", "createSpringSecurityUser");
