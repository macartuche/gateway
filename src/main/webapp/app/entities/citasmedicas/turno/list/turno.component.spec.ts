...
describe('Turno Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'turno', component: TurnoComponent }]), HttpClientTestingModule, TurnoComponent],
      providers: [
        {
  ...
  describe('trackId', () => {
    it('Should forward to turnoService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getTurnoIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getTurnoIdentifier).toHaveBeenCalledWith(entity);
