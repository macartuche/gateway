...
describe('Cronograma Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'cronograma', component: CronogramaComponent }]),
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.cronogramas?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to cronogramaService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getCronogramaIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getCronogramaIdentifier).toHaveBeenCalledWith(entity);
