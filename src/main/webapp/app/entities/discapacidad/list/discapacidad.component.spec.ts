...
describe('Discapacidad Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'discapacidad', component: DiscapacidadComponent }]),
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.discapacidads?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to discapacidadService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getDiscapacidadIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getDiscapacidadIdentifier).toHaveBeenCalledWith(entity);
