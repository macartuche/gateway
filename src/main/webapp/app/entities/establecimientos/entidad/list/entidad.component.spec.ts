...
describe('Entidad Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'entidad', component: EntidadComponent }]),
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.entidads?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to entidadService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getEntidadIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getEntidadIdentifier).toHaveBeenCalledWith(entity);
