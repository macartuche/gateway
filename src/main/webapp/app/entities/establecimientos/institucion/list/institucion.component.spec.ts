...
describe('Institucion Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'institucion', component: InstitucionComponent }]),
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.institucions?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to institucionService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getInstitucionIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getInstitucionIdentifier).toHaveBeenCalledWith(entity);
