...
describe('Distrito Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'distrito', component: DistritoComponent }]),
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.distritos?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to distritoService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getDistritoIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getDistritoIdentifier).toHaveBeenCalledWith(entity);
