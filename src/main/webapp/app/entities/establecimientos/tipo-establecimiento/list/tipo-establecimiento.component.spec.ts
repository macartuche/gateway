...
describe('TipoEstablecimiento Management Component', () => {
  let comp: TipoEstablecimientoComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'tipo-establecimiento', component: TipoEstablecimientoComponent }]),
      ...
      .overrideTemplate(TipoEstablecimientoComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.tipoEstablecimientos?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to tipoEstablecimientoService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getTipoEstablecimientoIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getTipoEstablecimientoIdentifier).toHaveBeenCalledWith(entity);
