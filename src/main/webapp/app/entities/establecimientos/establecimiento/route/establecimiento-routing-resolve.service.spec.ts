...
import establecimientoResolve from './establecimiento-routing-resolve.service';

describe('Establecimiento routing resolve service', () => {
  let mockRouter: Router;
  let mockActivatedRouteSnapshot: ActivatedRouteSnapshot;
  let service: EstablecimientoService;
  let resultEstablecimiento: IEstablecimiento | null | undefined;
  ...
  describe('resolve', () => {
    it('should return IEstablecimiento returned by find', () => {
      ...
      TestBed.runInInjectionContext(() => {
        establecimientoResolve(mockActivatedRouteSnapshot).subscribe({
          next(result) {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultEstablecimiento).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IEstablecimiento>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
