...
import { EntityArrayResponseType, EstablecimientoService } from '../service/establecimiento.service';
...
export class EstablecimientoComponent implements OnInit {
  ...
  trackId = (_index: number, item: IEstablecimiento): number => this.establecimientoService.getEstablecimientoIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.establecimientos = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IEstablecimiento[] | null): IEstablecimiento[] {
    return data ?? [];
  }
  ...
  protected queryBackend(page?: number, predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.establecimientoService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
