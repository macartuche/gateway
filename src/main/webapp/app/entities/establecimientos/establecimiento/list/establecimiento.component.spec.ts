...
describe('Establecimiento Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'establecimiento', component: EstablecimientoComponent }]),
  ...
  describe('trackId', () => {
    it('Should forward to establecimientoService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getEstablecimientoIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getEstablecimientoIdentifier).toHaveBeenCalledWith(entity);
