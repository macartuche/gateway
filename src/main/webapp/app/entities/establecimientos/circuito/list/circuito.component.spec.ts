...
describe('Circuito Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'circuito', component: CircuitoComponent }]),
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.circuitos?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to circuitoService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getCircuitoIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getCircuitoIdentifier).toHaveBeenCalledWith(entity);
