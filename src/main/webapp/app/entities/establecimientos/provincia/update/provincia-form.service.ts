...
type ProvinciaFormGroupContent = {
  ...
  codigo: FormControl<IProvincia['codigo']>;
  nombre: FormControl<IProvincia['nombre']>;
  zona: FormControl<IProvincia['zona']>;
};
...
export class ProvinciaFormService {
  createProvinciaFormGroup(provincia: ProvinciaFormGroupInput = { id: null }): ProvinciaFormGroup {
    ...
    return new FormGroup<ProvinciaFormGroupContent>({
      ...
      codigo: new FormControl(provinciaRawValue.codigo, {
        validators: [Validators.required],
      }),
      nombre: new FormControl(provinciaRawValue.nombre, {
        validators: [Validators.required],
      }),
      zona: new FormControl(provinciaRawValue.zona, {
        validators: [Validators.required],
      }),
    });
  }
